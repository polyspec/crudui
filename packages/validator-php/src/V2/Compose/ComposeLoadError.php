 ...
 * reference ComposeLoadError (validator-js/src/v2/compose/errors.ts).
 *
 ...
 * as valid:true (the v1 ProductNft.yml:873 bug). Every throw here is a load
 ...
 *   REF_CYCLE                   $ref cycle detected (A→B→A); v1 would infinite-recurse.

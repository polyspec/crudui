...
final class Patch
{
    ...
    public static function apply(array $base, mixed $patch): array
    {
        ...
        // Apply entries in declaration order (v2 properties preserve order).
    ...
    /**
     * Nested-map remove (v1 arr::remove): for each key, recurse when both the
     * target and the removal spec are objects, else unset the key. A missing key
     * is tolerated here (v1 arr::remove silently unsets), unlike the array form.
     *
     * @param array<string, mixed> $base

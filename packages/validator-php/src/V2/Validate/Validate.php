 ...
 *                 no validation result to return. This closes the v1
 ...
 *                 slot (conditional rule values evaluated by the v2 expression
 *                 engine, then handed to the reused v1 rule instances).
 *
 * The compose pass reuses the v2 compose module; the expression engine and rule
 * instances are reused as-is. Nothing here re-implements them, and nothing here
 * touches the v1 Validator (R7 parallel run).
 */
final class Validate
{
     ...
     *
     * Two entry shapes (JS validateV2 parity):
     ...
     *
     * @param array<string, mixed> $spec a v2 root spec (group with `properties`; may compose)

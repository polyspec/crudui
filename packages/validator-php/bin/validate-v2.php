...
<?php
/**
 * PHP v2 stdin validation worker (gateway subprocess).
 *
 * Contract (parallel to the v1 worker tests/runner/validate-case.php and the
 * v2 Go/Rust wrappers; the gateway spawns it with spawnSync, cwd = this

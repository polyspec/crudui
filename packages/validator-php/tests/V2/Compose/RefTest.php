...
/**
 * v1-parity unit tests for $ref resolution edge cases not isolated in cases.json:
 ...
 * validator-ts/src/v2/compose/ref.test.ts.
 */
final class RefTest extends TestCase
{
    // --- $ref cycle detection (v1 infinite-recurses; v2 must throw) -------
    ...
    // --- $ref declaration order (v1 positional array_merge) ---------------

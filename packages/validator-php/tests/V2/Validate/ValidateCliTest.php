...
/**
 * PHP v2 validate CLI — stdin/stdout BOUNDARY conformance.
 *
 * The Validate::run ENGINE is already pinned by ValidateConformanceTest. This
 * test owns only the CLI wrapper boundary (bin/validate-v2.php): serialization
 ...
 *
 * It spawns the REAL binary the cross-check gateway runs (`php bin/validate-v2.php`,

...
/**
 * PHP v2 validate CLI — list mode stdin/stdout BOUNDARY conformance.
 *
 * The ListValidate ENGINE is already pinned by ListValidateConformanceTest. This
 * test owns only the CLI wrapper boundary (bin/validate-v2.php with mode:"list"):
 ...
 *
 * The shared fixture tests/fixtures/v2-list-validity/cases.json is the truth via
 * its `engine` field:
...
final class ListValidateCliTest extends TestCase
{
    ...
    private const CLI = __DIR__ . '/../../../bin/validate-v2.php';
    ...
    /**
     * Spawn the CLI exactly as the gateway does: `php bin/validate-v2.php`,

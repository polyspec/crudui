/**
 * CRUDUI Vue form renderer — `Form` builds the composed field list as vnodes.
 *
 ...
 * @vue/server-renderer renderToString (ssr.ts) produces the legacy envelope
...
export function Form(fields: FieldViewModel[]): VNode {
  return h(
    'div',
    { class: 'form-group' },

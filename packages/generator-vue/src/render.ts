/**
 * CRUDUI SSR renderer — field → HTML (Vue 3 SSR target).
 *
 ...
 * (generator-svelte/src/render.ts; reproduced byte-for-byte by the React CRUDUI
 * reference generator-react/src/render.ts), reproduced byte-compatibly after

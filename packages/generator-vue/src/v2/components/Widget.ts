/**
 * v2 Vue widget renderer — real `h()` vnode containers, raw control bodies.
 *
...
function displayVNode(w: WidgetModel): VNode {
  ...
  // RAW html display (dummy/image-viewer) — unescaped v1 parity content, on a
 ...
 * empty-valued, and the host select needs `selected="selected"` (v1 select2

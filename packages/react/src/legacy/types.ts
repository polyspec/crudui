...
export type {
  ...
  ValidationResult,
  ValidationError,
} from '@limepie/form-validator/legacy';
...
export interface FormBuilderProps {
  ...
  spec: string | import('@limepie/form-validator/legacy').Spec;
  /** Initial form data */
  data?: FormData;
  /** Current language */
  language?: Language;
...
export interface ReactFieldSpec {
  ...
  // Validation
  rules?: import('@limepie/form-validator/legacy').RulesSpec;
  messages?: import('@limepie/form-validator/legacy').MessagesSpec;
  ...
  items?: Record<string, string> | import('@limepie/form-validator/legacy').ItemsSourceSpec;
...
export interface WrapperRenderProps {
  children: ReactNode;
  spec: import('@limepie/form-validator/legacy').Spec;

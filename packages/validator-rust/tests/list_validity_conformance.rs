...
//! (`packages/validator-ts/src/v2/list-metaschema.conformance.test.ts`). That
...
//!     `required`). NOT this test's concern (SPEC-V2 §8: the engine does no
...
//! (`crate::v2::list::validate_list` = compose → forbidden-scan); list has no data
...
fn fixture_path() -> PathBuf {
    ...
    // fixture lives at ../../tests/fixtures/v2-list-validity/cases.json.

//! v2 composition engine — SPEC-V2 §5, G5.
//!
...
//! (`packages/validator-ts/src/v2/compose`); the shared 4-language fixture
...
// (`packages/validator-ts/src/v2/compose/compose`), the byte-for-byte parity

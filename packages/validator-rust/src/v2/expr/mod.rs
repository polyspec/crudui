//! v2 expression engine — formal lexer→parser→AST→evaluator (EXPRESSION-GRAMMAR
...
//!
//! This is v2-new and runs parallel to the v1 engine (`crate::condition_parser`),
//! which is untouched (SPEC-V2 R7). No eval / no regex-split anywhere

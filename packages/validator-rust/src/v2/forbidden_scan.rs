...
//!
//! Forbidden set (SPEC-V2 §6): the enumerated `FORBIDDEN_META_KEYS`
...
//!
//! Byte-for-byte with the JS reference (`packages/validator-js/src/v2/
//! forbidden-scan.ts`); the shared 4-language fixture
//! `tests/fixtures/spec-validity/cases.json` is the single source of truth.

use serde_json::Value;

use crate::v2::compose::{ComposeErrorCode, ComposeLoadError};
use crate::v2::types::FORBIDDEN_META_KEYS;

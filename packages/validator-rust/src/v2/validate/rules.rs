//! v2 validation rule registry (VALIDATION-RULES, JS `rules/*` parity).
//!
...
//!
//! v2-NEW only in that the call site is the v2 validate slot; the rule SEMANTICS
//! are the v1 single source of truth re-expressed in Rust (R7 — never imports the
//! v1 `crate::rules` model).

use serde_json::Value;

use crate::v2::expr::Expression;

//! Spec parsing: canonical polyspec JSON (type/properties/rules) -> Spec.
...
use crate::types::{CustomRule, Field, Spec};
use serde_json::{Map, Value};

/// ParsedSpec is the result of parsing a canonical polyspec document.
...
/// parse_spec parses a canonical polyspec JSON value into a Spec.
...
///
/// A `"[]"`-suffix property key (e.g. `"items[]"`) is legacy Limepie shorthand
...
/// skipped (PHP Validator.php and client dist.validate.js parity).

/**
 * v1-parity unit tests for $ref resolution edge cases not isolated in
...
describe('$ref cycle detection (v1 infinite-recurses; v2 must throw)', () => {
  test('self-cycle a -> a', () => {
...
describe('$ref declaration order (v1 positional array_merge)', () => {

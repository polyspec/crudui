import { composeProperties, MemoryLoader, type FileLoader } from '@polyspec/validator';
...
export interface FormTemplate {
  ...
  readonly kind: 'polyspec/form-template';
...
export function compileForm(
  ...
  return freezeTree({
    kind: 'polyspec/form-template' as const,
    version: 1 as const,
...
export function bindForm(
  ...
  if (template.kind !== 'polyspec/form-template' || template.version !== 1) throw new TypeError('Unsupported form template');

/**
 * v2 React list component — `<ListV2>` renders a composed `ListViewModel`.
 *
 * The read sister of `<FormV2>`: where FormV2 maps a core `FieldViewModel[]`
 * (compose + design eval + i18n) to an input field tree, ListV2 maps a core
...
/** Props for the v2 list: the core-built view model + a layout selector. */
...
export function ListV2({ vm, layout = 'table' }: ListV2Props): React.ReactElement {

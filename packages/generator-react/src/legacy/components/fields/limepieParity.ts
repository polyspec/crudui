 ...
 *   - cleanStr           : \Limepie\clean_str()
 *   - nextChoiceToken    : \Limepie\genRandomString(5) charset, deterministic
 *   - limepieDataAttrs   : data-name / data-rule-name / data-default trio
 */
 ...
 * (ProductNft is_option: 0/2/1). PHP arrays keep that order; plain JS
...
/**
 * The Limepie validation attribute trio. data-default uses PHP string

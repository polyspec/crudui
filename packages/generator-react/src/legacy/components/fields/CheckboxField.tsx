 ...
 * Matches PHP Legacy structure: div.form-check > input.form-check-input + label.form-check-label
 */
...
import { getLegacyDataAttributes, toBracketNotationWithPrefix, getCheckboxClasses } from '../../utils/dataAttributes';

/**
 * CheckboxField component
 * PHP Legacy structure:

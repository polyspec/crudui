 ...
 *
 * Legacy PHP reference structure (Fields/DummyInput.php), verified via
 * tools/legacy-baseline/render.php:
...
import { applyDefaultString, parseStyleString, phpString } from './legacyParity';

/**
 * v2 Svelte list helpers — pure presentational string computations (NO markup).
 *
 * ListV2.svelte owns the real table/card element tree; these helpers only map the
 ...
 * .svelte tree in ListV2.svelte; these are only the leaf appearance/raw bits.
 */

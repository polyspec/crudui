/**
 * v2 SSR renderer (Svelte) — field → HTML.
 *
 ...
 *
 * This module is a string-building renderer (the same shape as the React/Vue v2
 * references); the Svelte 5 SSR component (FormV2.svelte) emits the produced HTML
 ...
 * parity, tests/fixtures/v2-render).
 *

/**
 * v2 generator low-level helpers (Svelte) — framework-independent string/name/
 * path primitives. Reproduce the verified Limepie envelope conventions
 * (generator-svelte/src/components/fields/limepieParity.ts) so the v2 envelope is
 * bit-identical to the proven v1 output after normalization. NO v1 meta key is
 ...
 *
 * The shared parity gate (tests/fixtures/v2-render) pins these against the React
 * v2 reference output; do not diverge.
 */

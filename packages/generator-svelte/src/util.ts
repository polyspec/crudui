 ...
 * path primitives. Reproduce the verified Limepie envelope conventions
 * (generator-svelte/src/components/fields/limepieParity.ts) so the CRUDUI envelope is
 ...
 * php-string casts, explicit position-index identity, value lookup).
 *

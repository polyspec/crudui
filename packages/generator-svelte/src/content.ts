/**
 * CRUDUI content translation (Svelte) — G3 axis 1: author translation of CONTENT.
 *
 ...
 * string for the active language; the resolution order matches the React/Vue CRUDUI

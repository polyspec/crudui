/**
 * v2 expression-engine conformance — JS reference verification.
 *
...
// src/v2 -> repo root is five levels up.
...
describe('v2 expr — lexer matches fixture (JS reference)', () => {
...
describe('v2 expr — parser matches fixture (JS reference)', () => {
  for (const spec of specs) {
    test(spec.name, () => {
...
describe('v2 expr — evaluation matches fixture (JS reference)', () => {
  for (const spec of specs) {
    test(spec.name, () => {

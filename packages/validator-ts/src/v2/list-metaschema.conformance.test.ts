...
describe('v2 list meta-schema — additive: Field entry point is untouched', () => {
...
describe('v2 list meta-schema — a valid list-spec passes (§9.4)', () => {
...
describe('v2 list meta-schema — an invalid list-spec is REJECTED (RED cases, §9.4)', () => {

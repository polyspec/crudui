...
// Shared helpers for the v2 validate engine: path-string parsing, field-reference
...
// directly: the v2 expr engine resolves paths inside expressions, but a rule param
...
// rule semantics, matching the v1 Go url rule).

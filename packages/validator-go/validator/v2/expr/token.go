// Package expr is the Go v2 expression engine (EXPRESSION-GRAMMAR §0-§7).
//
...
//
// This is the v2 engine. It runs in parallel with the v1 condition_parser in
// package validator (R7); nothing here imports v1 and v1 imports nothing here.
//

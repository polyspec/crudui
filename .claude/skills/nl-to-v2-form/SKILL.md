---
name: nl-to-v2-form
description: 자연어 기획서/구술을 검증 통과하는 form-spec v2 스펙으로 변환한다. 사용자가 폼 설계서·필드 목록·요구사항을 주고 v2 스펙(YAML/JSON)을 요청할 때, 또는 기존 v2 스펙을 자연어 의도와 대조·수정할 때 사용한다.
---

# 자연어 → v2 form 생성

자연어 기획서/구술을 `form-spec check` + `validate`를 통과하는 form-spec v2 스펙으로 만든다.

...
Polyspec은 YAML 또는 JavaScript 객체로 폼과 검증을 정의합니다. 공유 코어가 데이터
로드 전에 폼 구조를 컴파일합니다. React, Vue, Svelte는 편집 가능한 인스턴스를
렌더링하고 TypeScript, PHP, Go, Rust는 제출 데이터를 검증합니다.
...
- [브라우저 비교와 PHP·Go·Rust 영속 저장](docs/operations/form-comparison.ko.md)

#!/usr/bin/env node
/**
 * gen-schema.mjs — generate schema/crudui.schema.json from validator-ts types.
 *
 ...
 * sorted output, so repeated runs produce byte-identical schema/crudui.schema.json.
...
const SCHEMA_FILE = join(SCHEMA_DIR, 'crudui.schema.json');
...
const args = [
  ...
  '--path', TYPES,
  '--type', 'Spec',
  '--id', 'https://github.com/crudui/crudui/schema/crudui.schema.json',

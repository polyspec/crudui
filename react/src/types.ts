...
export interface FormBuilderProps {
  ...
  spec: string | import('@legacy/form-validator').Spec;
  /** Initial form data */
  data?: FormData;
  /** Current language */
  language?: Language;
...
export interface ReactFieldSpec {
  ...
  // Validation
  rules?: import('@legacy/form-validator').RulesSpec;
  messages?: import('@legacy/form-validator').MessagesSpec;
  ...
  items?: Record<string, string> | import('@legacy/form-validator').ItemsSourceSpec;
...
export interface WrapperRenderProps {
  children: ReactNode;
  spec: import('@legacy/form-validator').Spec;

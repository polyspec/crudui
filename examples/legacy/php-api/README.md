...
PHP API example demonstrating crudui validation with Limepie and Laravel integration patterns.
...
└── src/
    ...
    ├── CRUDUIServiceProvider.php # Laravel service registration
    ├── CRUDUIAdapter.php         # Specification validation
    ├── ExampleController.php      # Controller examples
    └── CRUDUIRequest.php         # Form request example
```

## Related Documentation

- [YAML Spec Format](../../../docs/spec/schema.md)
- [Validation Rules](../../../docs/spec/validation-rules.md)

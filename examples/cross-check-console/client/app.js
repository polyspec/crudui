 ...
 * tests/fixtures/v2-list-render/cases.json shape, one case per framework:
...
function mountShell() {
  root.innerHTML = `
    <header class="cc-header">
      <h1>Cross-Check Console <span class="cc-sub">polyspec v2</span></h1>
...
/**
 * List validate matrix — the 4-language v2 list STRUCTURE validate fan-out
...
/** List render matrix — the 3-framework v2 list SSR fan-out (/api/render-list). */

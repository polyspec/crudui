 ...
 * Each entry quotes a real v2-list-render fixture so the doc never drifts from
...
export const listDocSections = [
  {
    ...
    body:
      ...
      '출처: v2-list-render basic-columns.',
  },
  {
    title: '포맷 (format)',
    body:
      ...
      '출처: v2-list-render format-date/number/badge/bool.',
  },
  {
    ...
    body:
      ...
      '출처: v2-list-render column-show-expr-hidden/visible.',
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      '출처: v2-list-render pagination-display/sort-display.',
  },
  {

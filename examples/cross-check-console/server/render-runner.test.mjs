 ...
 *       v2-render fixture across React/Svelte/Vue and assert real parity.
 *
...
const RENDER_FIXTURE = path.resolve(ROOT, 'tests/fixtures/v2-render/cases.json');
...
describe('renderAll — real 3-framework SSR fan-out (representative fixture)', () => {
  test(`[selected: ${SMOKE_NAME} of ${allCases.length} v2-render cases] React/Svelte/Vue agree → parity:true`, async () => {

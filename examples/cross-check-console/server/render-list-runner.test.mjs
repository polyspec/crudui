 ...
 * calls: it fans one list-spec + INJECTED rows across the three v2 ListV2 SSR
 ...
 *       tests/fixtures/v2-list-render/cases.json — the SAME file the three
...
const LIST_FIXTURE = path.resolve(ROOT, 'tests/fixtures/v2-list-render/cases.json');

...
An interactive web playground for testing and developing form specifications using the `@legacy/form-react` library.
...
Form specs follow the YAML format used by `@legacy/form-react`. Here's a basic example:
...
- **@legacy/form-react** - Form builder library
- **yaml** - YAML parsing

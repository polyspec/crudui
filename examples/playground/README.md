...
An interactive web playground for testing and developing form specifications using the `@polyspec/generator-react` library.
...
1. First, build the `@polyspec/generator-react` library:
...
Form specs follow the YAML format used by `@polyspec/generator-react`. Here's a basic example:
...
- **@polyspec/generator-react** - Form builder library
- **yaml** - YAML parsing

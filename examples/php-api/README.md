...
use App\LegacyValidationTrait;

class MyController extends \Legacy\Controller
{
    use LegacyValidationTrait;
...
use App\LegacyAdapter;

// Create adapter instance
$adapter = new LegacyAdapter(__DIR__ . '/specs');
...
└── src/
    ├── LegacyAdapter.php    # Legacy integration

...
require (
	...
	github.com/crudui/crudui/packages/generator-go v0.0.1
	github.com/crudui/crudui/packages/validator-go v0.0.1
)

replace github.com/crudui/crudui/packages/generator-go => ../../../../packages/generator-go

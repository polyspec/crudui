...
const text = {
  ko: { title: 'CRUDUI 전체 기능 예제', intro: 'CRUDUI가 생성한 목록 링크로 상세와 폼으로 이동하고 실제 저장 결과를 다시 목록에서 확인합니다.', server: '서버', framework: '클라이언트', initialization: '실행 방식', list: '고객 목록', detail: '고객 상세', form: '고객 수정', source: '소스 식별자', ssr: 'SSR', csr: 'CSR', backList: '목록으로 돌아가기' },
  en: { title: 'CRUDUI full feature example', intro: 'Use CRUDUI-generated list links to open detail and form, then verify the saved result in the list.', server: 'Server', framework: 'Client', initialization: 'Execution', list: 'Customer list', detail: 'Customer detail', form: 'Edit customer', source: 'Source identity', ssr: 'SSR', csr: 'CSR', backList: 'Back to list' },
}[state.language];

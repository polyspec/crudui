...
`cases.json`은 React, Vue, Svelte, HTML 렌더러의 공용 목록 레이아웃 사례입니다. 각 사례는
...
렌더러의 이미지 preload 링크를 포함한 전체 원본 HTML을 React와 비교합니다. 리소스 힌트를
...
[HTML 렌더러](../../../packages/generator-html/src/list-conformance.test.ts)의

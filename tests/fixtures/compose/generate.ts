/**
 * Shared-fixture generator for the 4-language composition engine (SPEC-V2 §5).
 *
...
import {
  ...
  MemoryLoader,
  ComposeLoadError,
} from '/Users/max/ai/gui/form-spec/packages/validator-ts/src/v2/compose/index';
...
const SPECS: CaseSpec[] = [
  ...
  //    (reduced ProductNft.yml:873 + OptionMultiplexable.yml).
  {
  ...
  // 11. sibling key declared after $ref overrides the base (v1 declaration order).
  {
  ...
  // 14. unresolved file — must be a load error, NOT valid:true.
  {
    ...
    note: 'missing $ref file is a load error (not valid:true; v1 ProductNft:873 bug)',
    input: {
      files: {},

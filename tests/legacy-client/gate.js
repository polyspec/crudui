 ...
 *
 * Drives the legacy browser runtime (examples/legacy/legacy-original/assets/js/
...
if (require.main === module) {
  ...
  console.log(`${C.gray}legacy: examples/legacy/legacy-original/assets/js/legacy-client.validate.js (jsdom+jQuery)${C.reset}`);

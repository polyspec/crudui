...
Set `ORDERED_JSON_SOURCE` to an absolute checkout path. Run from the Polyspec root
...
cases against all five implementations. The second runs ten Polyspec JSON

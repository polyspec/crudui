...
Go(`packages/validator-go/validator/legacy/condition_parser.go`, `path_resolver.go`,
`ternary.go`), PHP(`packages/validator-php/src/Legacy/ConditionParser.php`,
`PathResolver.php`), Rust(`packages/validator-rust/src/legacy/condition_parser.rs`,

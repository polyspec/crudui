...
features:
  ...
  - title: v2 도구체인
    details: form-spec CLI(describe/check/explain/list-widgets) · MCP · 크로스-검증 콘솔(4언어 검증 × 3프레임워크 SSR) · nl-to-v2-form 스킬. 모두 코드/스키마 단일진실에 위임한다.
  - title: 기계가독 스펙
...
| 도구 | `form-spec-cli` (`@polyspec/cli`, bin `form-spec`) | describe/check/explain/list-widgets |
...
- [form-spec CLI](/FORM-SPEC-CLI) · [form-spec MCP](/FORM-SPEC-MCP) — v2 작성 도구층

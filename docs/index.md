...
| 렌더러 | `generator-react` (`@form-spec/generator-react`) | 기준 HTML 7/7 parity, list ListV2 |
| 렌더러 | `generator-vue` (`@form-spec/generator-vue`) | SSR, 기준 HTML 7/7 parity, list ListV2 |
| 렌더러 | `generator-svelte` (`@form-spec/generator-svelte`) | SSR, 기준 HTML 7/7 parity, list ListV2 |

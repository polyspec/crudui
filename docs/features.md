...
| form-focus | Focus, selection and scroll retention during row operations | implemented | pending | not-deployed | [Mounted DOM checks](../tests/fixtures/form-session/scenario.mjs) |

...
| comparison-deployment | Verified local comparison deployment and unchanged reapplication | implemented | passed | not-deployed | [Form verification procedure](operations/verification.md) |

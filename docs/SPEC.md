...
(`packages/generator-react/src/types.ts:78` `spec: string | Spec`).
...
```typescript
// packages/generator-react/src/types.ts:29-34
...
legacy Limepie 시스템의 기능이며, 필요 시 향후 도입 후보다.

...
> Legacy PHP 폼 시스템의 YAML 스펙 형식에 대한 완전한 기술 명세서입니다.
...
Legacy YAML 스펙은 폼의 구조, 필드, 검증 규칙, 동작을 선언적으로 정의하는 형식입니다. 단일 YAML 파일로 클라이언트와 서버 양쪽에서 동일한 검증 로직을 실행할 수 있습니다.
...
Legacy 시스템은 20개 이상의 필드 타입을 지원합니다.
...
*이 문서는 Legacy PHP 폼 시스템의 YAML 스펙 형식에 대한 공식 명세서입니다.*
*버전: 1.0.0*
*최종 수정: 2026-01-04*

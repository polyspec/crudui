...
Sticky row lines are offset upward by the row border width so the moving row box meets the
sticky layer without leaving a one-pixel remainder. The header border and header height are
unchanged.

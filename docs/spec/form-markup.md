...
The footer has no decorative top border. A row retains its outer bottom border to close its
card, and its header has no bottom border, so the two edges cannot be duplicated in the row
layout.

 ...
 * parsing is a JS-only concern (ProductNft.yml needs the eemeli `yaml`
 ...
 *   productnft.spec.json  productnft.input.json
 *
...
/** Load a Limepie YAML spec the same way the parity suite does. */
 ...
 *
 * productnft: the EMPTY form ({}). The raw Limepie ProductNft.yml carries
...
const CASES = [
  ...
  {
    name: 'productnft',
    spec: 'tests/fixtures/specs/ProductNft.yml',
